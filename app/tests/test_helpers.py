...
class TestInferSourceType:
    ...
    def test_http_matching_base_url_is_internal(self):
        ...
        assert infer_source_type("https://v2hub.link/sub/abc", "https://v2hub.link") == "internal_token"
...
class TestCleanSourceEntries:
    ...
    def test_full_dict(self):
        result = clean_source_entries(
            [{"data": "vless://a", "is_hidden": True, "max_depth": 1}]
        )
    ...
    def test_mixed_list_only_dicts_survive(self):
        result = clean_source_entries(
            [{"data": "vless://a"}, "vless://b", {"data": "vless://c"}]
        )
