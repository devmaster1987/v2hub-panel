...
function createSettingsModal() {
  ...
  modal.innerHTML = `
    <div class="modal">
      ...
      <div class="setting-row" style="display:flex;justify-content:space-between;align-items:center;padding:8px 0;border-bottom:1px solid var(--line);">

        <div class="setting-row-text" style="flex:1;padding-right:12px;">
          <div class="setting-row-title">Dark Theme</div>
